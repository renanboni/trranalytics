...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("AnalyticsEventExtensionsKt")))
@interface SharedAnalyticsEventExtensionsKt : SharedBase

/**
 * Extension function for AnalyticsEvent to get full payload as a native Map.
 */
+ (NSDictionary<NSString *, id> *)payloadMap:(id<SharedAnalyticsEvent>)receiver __attribute__((swift_name("payloadMap(_:)")));
 ...
 */
+ (NSDictionary<NSString *, id> *)propertiesMap:(id<SharedAnalyticsEvent>)receiver __attribute__((swift_name("propertiesMap(_:)")));
 ...
 */
+ (NSDictionary<NSString *, id> *)toMap:(NSDictionary<NSString *, SharedKotlinx_serialization_jsonJsonElement *> *)receiver __attribute__((swift_name("toMap(_:)")));
@end
